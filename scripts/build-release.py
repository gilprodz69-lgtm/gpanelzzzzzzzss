...
SCRIPT_NAMES = ['console.php', 'health.php', 'register-local-server.php', 'install-ubuntu.sh', 'update.sh', 'install-runtime.sh', 'apt-safe.sh', 'upgrade-ubuntu.sh', 'upgrade-config.php', 'panel-certificate.py', 'wait-agent.py', 'repair-php-runtime.py']
